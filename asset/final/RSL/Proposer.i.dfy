...
module LiveRSL__Proposer_i {
  ...
  /**
  byzpaxos中，通过LAllAcceptorsHadNoProposal检查当前ballot是否有人给opn投过票，和BPCon的KnowsSafeAt的第一个条件一样
  如果没有，发送1c，附加上收到的1b list
  如果有，通过KnowsSafeAt的第二个条件，选出这个值，并附加上收到的1b list */
