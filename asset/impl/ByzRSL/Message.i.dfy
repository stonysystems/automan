...
module Impl_LiveByzRSL__Message_i 
{
	...
	predicate CMessageIsValid(s: CMessage) 
	{
		...
		case CMessage_2av(bal_2av, opn_2av, val_2av) => CMessageIsAbstractable(s) && CBallotIsValid(s.bal_2av) && COperationNumberIsValid(s.opn_2av) && CRequestBatchIsValid(s.val_2av)
