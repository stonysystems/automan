...
module Impl_LiveByzRSL__Executor_i 
{
	...
	function method CExecutorExecute(s: CExecutor) : (CExecutor, OutboundPackets) 
		...
		ensures var (s', sent_packets) := CExecutorExecute(s); CExecutorIsValid(s') && OutboundPacketsIsValid(sent_packets) && LExecutorExecute(AbstractifyCExecutorToLExecutor(s), AbstractifyCExecutorToLExecutor(s'), AbstractifyOutboundCPacketsToSeqOfRslPackets(sent_packets))
	{
		var t1 := 
			var batch := 
	...
	function method CExecutorProcessAppStateRequest(s: CExecutor, inp: CPacket) : (CExecutor, OutboundPackets) 
		...
		ensures var (s', sent_packets) := CExecutorProcessAppStateRequest(s, inp); CExecutorIsValid(s') && OutboundPacketsIsValid(sent_packets) && LExecutorProcessAppStateRequest(AbstractifyCExecutorToLExecutor(s), AbstractifyCExecutorToLExecutor(s'), AbstractifyCPacketToRslPacket(inp), AbstractifyOutboundCPacketsToSeqOfRslPackets(sent_packets))
	{
		var t1 := 
			var m := 
				inp.msg; 			
	...
	function method CExecutorProcessStartingPhase2(s: CExecutor, inp: CPacket) : (CExecutor, OutboundPackets) 
		...
		ensures var (s', sent_packets) := CExecutorProcessStartingPhase2(s, inp); CExecutorIsValid(s') && OutboundPacketsIsValid(sent_packets) && LExecutorProcessStartingPhase2(AbstractifyCExecutorToLExecutor(s), AbstractifyCExecutorToLExecutor(s'), AbstractifyCPacketToRslPacket(inp), AbstractifyOutboundCPacketsToSeqOfRslPackets(sent_packets))
	{
		var t1 := 
	...
	function method CExecutorProcessRequest(s: CExecutor, inp: CPacket) : OutboundPackets 
		...
		ensures var sent_packets := CExecutorProcessRequest(s, inp); OutboundPacketsIsValid(sent_packets) && LExecutorProcessRequest(AbstractifyCExecutorToLExecutor(s), AbstractifyCPacketToRslPacket(inp), AbstractifyOutboundCPacketsToSeqOfRslPackets(sent_packets))
	{
		var t1 := 
