    ...
    public class Client : ClientBase
    {
        ...
        protected override void Setup(int base_client_port, ulong id, ulong num_keys, ulong size_value)
        {
            ...
            while (seq_num < num_keys)
            {
                ...
                // Console.WriteLine("send to: {0} ", ClientBase.endpoints[serverIdx]);
        ...
        protected override void Experiment(int base_client_port, ulong id, ulong num_keys, ulong size_value, char workload, int []num_req_cnt_a_, double []latency_cnt_ms_a_)
        {
            // Console.WriteLine("port: ", base_client_port, " id: ", id, " knum: ", num_keys, " load: ", workload);
