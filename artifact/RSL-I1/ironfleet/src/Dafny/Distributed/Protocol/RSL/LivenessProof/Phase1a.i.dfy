...
module LivenessProof__Phase1a_i {
  ...
  import opened LivenessProof__max_balISent1a_i
  import opened LivenessProof__max_bal_i
  ...
  predicate Primarymax_balISent1aInView(
    ps:RslState,
    view:Ballot
  )
  {
  ...
  function{:opaque} Primarymax_balISent1aInViewTemporal(
    b:Behavior<RslState>,
               view:Ballot
  ):temporal
    requires imaptotal(b)
    ensures  forall i{:trigger sat(i, Primarymax_balISent1aInViewTemporal(b, view))} ::
               sat(i, Primarymax_balISent1aInViewTemporal(b, view)) == Primarymax_balISent1aInView(b[i], view)
  {
    stepmap(imap i :: Primarymax_balISent1aInView(b[i], view))
  }
  ...
  lemma lemma_PrimaryInViewLeadsToPrimarymax_balISent1aInViewWF1Req1(
    b:Behavior<RslState>,
    asp:AssumptionParameters,
    start_step:int,
    view:Ballot
    ...
    ensures  var P := PrimaryInViewTemporal(b, view);
             var Q := or(Primarymax_balISent1aInViewTemporal(b, view), not(NoReplicaBeyondViewTemporal(b, view)));
  ...
  lemma lemma_PrimaryInViewLeadsToPrimarymax_balISent1aInViewWF1Req2(
    b:Behavior<RslState>,
    asp:AssumptionParameters,
    start_step:int,
    view:Ballot
             ...
             sat(start_step, always(TemporalWF1Req2(P, Q, Action)))
  {
      ...
      ensures sat(i, TemporalWF1Req2(P, Q, Action))
    {
      if sat(i, P) && sat(i, Action) && !sat(i, Q) && !sat(i+1, Q)
      {
        ...
        lemma_NoReplicaBeyondViewImpliesNomax_balISent1aBeyondView(b, asp, i, view);
  ...
  lemma lemma_PrimaryInViewLeadsToPrimarymax_balISent1aInView(
    b:Behavior<RslState>,
    asp:AssumptionParameters,
    start_step:int,
    view:Ballot
    ...
    ensures  sat(start_step, leadstowithin(PrimaryInViewTemporal(b, view),
                                           or(Primarymax_balISent1aInViewTemporal(b, view), not(NoReplicaBeyondViewTemporal(b, view))),
                                           ...
                                           PaxosTimeMap(b)))
  {
    ...
    lemma_PrimaryInViewLeadsToPrimarymax_balISent1aInViewWF1Req1(b, asp, start_step, view);
    lemma_PrimaryInViewLeadsToPrimarymax_balISent1aInViewWF1Req2(b, asp, start_step, view);
  ...
  lemma lemma_StablePeriodStartedLeadsToPrimarymax_balISent1aInView(
    b:Behavior<RslState>,
    asp:AssumptionParameters,
    start_step:int,
    processing_bound:int,
                                           ...
                                           PaxosTimeMap(b)))
  {
    ...
    var y := Primarymax_balISent1aInViewTemporal(b, view);
    ...
    lemma_PrimaryInViewLeadsToPrimarymax_balISent1aInView(b, asp, start_step, view);
  ...
  lemma lemma_IfPrimaryTransitionsTomax_balISent1aInViewThenPrimarySent1a(
    b:Behavior<RslState>,
    asp:AssumptionParameters,
    i:int,
    view:Ballot
    ...
    requires LivenessAssumptions(b, asp)
    requires 0 <= i
    requires !sat(i, Primarymax_balISent1aInViewTemporal(b, view))
    requires sat(i+1, Primarymax_balISent1aInViewTemporal(b, view))
                                             ...
                                             eventuallywithin(not(NoReplicaBeyondViewTemporal(b, view)), t, f)))))
  {
    ...
    lemma_StablePeriodStartedLeadsToPrimarymax_balISent1aInView(b, asp, start_step, processing_bound, view, ahead_idx);
      ...
      ensures sat(j, imply(x, or(eventuallynextwithin(w, t, f), eventuallywithin(z, t, f))))
    {
      ...
      if sat(j, x) && !sat(j, eventuallywithin(z, t, f))
      {
        ...
        lemma_IfPrimaryTransitionsTomax_balISent1aInViewThenPrimarySent1a(b, asp, k, view);
