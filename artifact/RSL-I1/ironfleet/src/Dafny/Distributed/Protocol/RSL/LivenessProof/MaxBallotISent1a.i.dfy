...
module LivenessProof__max_balISent1a_i {
...
lemma lemma_max_balISent1aLeqView(
  b:Behavior<RslState>,
  ...
  decreases i
{
  if i > 0
  {
    ...
    lemma_max_balISent1aLeqView(b, asp, i-1, idx);
...
lemma lemma_NoReplicaBeyondViewImpliesNomax_balISent1aBeyondView(
  b:Behavior<RslState>,
  asp:AssumptionParameters,
  i:int,
  view:Ballot
  ...
  ensures  Nomax_balISent1aBeyondView(b[i], view)
{
