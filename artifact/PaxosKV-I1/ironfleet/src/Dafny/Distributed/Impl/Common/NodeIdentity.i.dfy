...
function{:opaque} AbstractifyNodeIdentityToEndPoint(id:NodeIdentity) : EndPoint
    ...
    ensures  NodeIdentityIsRefinable(id) ==> EndPointIsAbstractable(AbstractifyNodeIdentityToEndPoint(id))
    ensures  NodeIdentityIsRefinable(id) ==> AbstractifyEndPointToNodeIdentity(AbstractifyNodeIdentityToEndPoint(id)) == id
  {
    var e := id;
    lemma_AbstractifyNodeIdentityToEndPoint(id, e);
    e
  }

lemma {:axiom} lemma_AbstractifyNodeIdentityToEndPoint(id:NodeIdentity, e:EndPoint)
  ensures NodeIdentityIsRefinable(id) ==> EndPointIsAbstractable(e)
    ensures  NodeIdentityIsRefinable(id) ==> AbstractifyEndPointToNodeIdentity(e) == id
