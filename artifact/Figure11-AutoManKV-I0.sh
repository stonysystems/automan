...
for workload in "${workloads[@]}"; do
  for valuesize in "${valuesizes[@]}"; do
    ...
    for nthreads in "${nthreads_list[@]}"; do
      ...
      # dotnet $CODE_DIR/ironfleet/src/Dafny/Distributed/Services/SHT/build/IronfleetShell.dll 130.245.173.104 5001 130.245.173.104 5002 130.245.173.104 5003 130.245.173.104 5001 &
      # PID1=$!
      # dotnet $CODE_DIR/ironfleet/src/Dafny/Distributed/Services/SHT/build/IronfleetShell.dll 130.245.173.104 5001 130.245.173.104 5002 130.245.173.104 5003 130.245.173.104 5002 &
      # PID2=$!
      # dotnet $CODE_DIR/ironfleet/src/Dafny/Distributed/Services/SHT/build/IronfleetShell.dll 130.245.173.104 5001 130.245.173.104 5002 130.245.173.104 5003 130.245.173.104 5003 &
      # PID3=$!
