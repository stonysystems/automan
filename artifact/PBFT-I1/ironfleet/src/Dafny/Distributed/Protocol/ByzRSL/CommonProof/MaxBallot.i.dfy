...
module CommonProof__max_bal_i {
  ...
  // lemma lemma_MaxBalLeqmax_balPrimarySent1a(
  //   b:Behavior<RslState>,
  //   c:LConstants,
  //   i:int,
  //   idx:int
  ...
  //     if max_bal == max_bal'
  //     {
  //       lemma_MaxBalLeqmax_balPrimarySent1a(b, c, i-1, idx);
  //       lemma_max_balISent1aMonotonicOneStep(b, c, i-1, max_bal.proposer_id);
  //     }
  //     else
  //     {
