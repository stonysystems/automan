...
predicate {:opaque} Q_LReplica_Next_Process_1c(replica:LReplica, replica':LReplica, lpacket:RslPacket, sent_packets:seq<RslPacket>)
{ lpacket.msg.RslMessage_1c? && LReplicaNextProcess1c(replica, replica', lpacket, sent_packets) }

predicate {:opaque} Q_LReplica_Next_Process_2av(replica:LReplica, replica':LReplica, lpacket:RslPacket, sent_packets:seq<RslPacket>)
{ lpacket.msg.RslMessage_2av? && LReplicaNextProcess2av(replica, replica', lpacket, sent_packets) }
...
//  && clock == SpontaneousClock(ios)
  && (|| (lpacket.msg.RslMessage_Request? && Q_LReplica_Next_Process_Request(replica, replica', lpacket, sent_packets))
     ...
     || (lpacket.msg.RslMessage_1c? && Q_LReplica_Next_Process_1c(replica, replica', lpacket, sent_packets))
     || (lpacket.msg.RslMessage_2av? && Q_LReplica_Next_Process_2av(replica, replica', lpacket, sent_packets))
...
predicate {:opaque} Q_LReplica_Next_Spontaneous_MaybeDecide2bVal(replica:LReplica, replica':LReplica, sent_packets:seq<RslPacket>)
{ LReplicaNextSpontaneousMaybeDecide2bVal(replica, replica', sent_packets) }

predicate {:opaque} Q_LReplica_Next_Spontaneous_MaybeSend2b(replica:LReplica, replica':LReplica, sent_packets:seq<RslPacket>)
...
lemma lemma_EstablishQLReplicaNoReceiveNextFromNoClock(replica:LReplica, replica':LReplica, sent_packets:seq<RslPacket>, nextActionIndex:int, ios:seq<RslIo>)
  ...
  requires
    ...
    || (nextActionIndex==4 && Q_LReplica_Next_Spontaneous_MaybeDecide2bVal(replica, replica', sent_packets))
    || (nextActionIndex==5 && Q_LReplica_Next_Spontaneous_MaybeSend2b(replica, replica', sent_packets))
    || (nextActionIndex==6 && Q_LReplica_Next_Spontaneous_TruncateLogBasedOnCheckpoints(replica, replica', sent_packets))
    || (nextActionIndex==7 && Q_LReplica_Next_Spontaneous_MaybeMakeDecision(replica, replica', sent_packets))
    || (nextActionIndex==8 && Q_LReplica_Next_Spontaneous_MaybeExecute(replica, replica', sent_packets));
...
predicate {:opaque} Q_LReplica_Next_ReadClock_MaybeNominateValueAndSend1c(replica:LReplica, replica':LReplica, clock:ClockReading, sent_packets:seq<RslPacket>)
...
predicate Establish_Q_LReplica_NoReceive_Next_preconditions(replica:LReplica, replica':LReplica, clock:ClockReading, sent_packets:seq<RslPacket>, nextActionIndex:int, ios:seq<RslIo>)
{
  ...
  && sent_packets == ExtractSentPacketsFromIos(ios)
  && clock == SpontaneousClock(ios)
  && (|| (nextActionIndex==3 && Q_LReplica_Next_ReadClock_MaybeNominateValueAndSend1c(replica, replica', clock, sent_packets))
     || (nextActionIndex==9 && Q_LReplica_Next_ReadClock_CheckForViewTimeout(replica, replica', clock, sent_packets))
     || (nextActionIndex==10 && Q_LReplica_Next_ReadClock_CheckForQuorumOfViewSuspicions(replica, replica', clock, sent_packets))
     || (nextActionIndex==11 && Q_LReplica_Next_ReadClock_MaybeSendHeartbeat(replica, replica', clock, sent_packets)))
  && sent_packets == ExtractSentPacketsFromIos(ios)
}
