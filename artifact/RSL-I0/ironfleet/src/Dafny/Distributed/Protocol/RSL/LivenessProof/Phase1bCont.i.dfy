...
module LivenessProof__Phase1bCont_i {
    ...
    ensures  b[step].environment.time <= b[i+1].environment.time + processing_bound
  {
    ...
    else
    {
      ...
      if exists other_packet :: other_packet in s2.proposer.received_1b_packets && other_packet.src == p.src
      {
        ...
        lemma_Received1bPacketsAreFrommax_balISent1a(b, asp.c, step, primary_idx);
      ...
      ensures sat(j, always(t))
    {
        ...
        ensures false
      {
        ...
        else
        {
          ...
          lemma_NoReplicaBeyondViewImpliesNomax_balISent1aBeyondView(b, asp, k, view);
          lemma_max_balISent1aLeqView(b, asp, k, primary_idx);
          ...
          lemma_max_balISent1aLeqView(b, asp, k+1, primary_idx);
          lemma_max_balISent1aMonotonicOneStep(b, asp.c, k, primary_idx);
             ...
             sat(i, TemporalWF1Req2(P, Q, Action))
  {
    ...
    if sat(i, P) && !sat(i, Q) && sat(i, Action)
    {
      ...
      lemma_Received1bPacketsAreFrommax_balISent1a(b, asp.c, i, primary_idx);
