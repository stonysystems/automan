...
module LivenessProof__Phase2Invariants_i {
    ...
    decreases i
  {
    ...
    if i > h.start_step + 1
    {
      ...
      lemma_max_balISent1aLeqView(b, asp, i-1, h.view.proposer_id);
      ...
      lemma_NoReplicaBeyondViewImpliesNomax_balISent1aBeyondView(b, asp, i, h.view);
    ...
    decreases i
  {
    ...
    if opn < s.acceptor.log_truncation_point + asp.c.params.max_log_length
    {
      ...
      lemma_max_balISent1aLeqView(b, asp, i, idx);
    ...
    ensures  BalLeq(b[i].replicas[idx].replica.acceptor.max_bal, h.view)
  {
    ...
    {
      lemma_MaxBalLeqmax_balPrimarySent1a(b, asp.c, i, idx);
  ...
  lemma lemma_Learnermax_balSeenNeverExceedsViewDuringPhase2(
    b:Behavior<RslState>,
    asp:AssumptionParameters,
    h:Phase2Params,
    i:int,
    ...
    ensures  BalLeq(b[i].replicas[idx].replica.learner.max_ballot_seen, h.view)
  {
    ...
    lemma_Learnermax_balSeenShowsPrimaryReachedState2(b, asp.c, i, idx);
