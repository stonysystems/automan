...
include "../RSL/CMessage.i.dfy"
include "../RSL/AppInterface.i.dfy"
...
module LiveRSL__CMessageRefinements_i {
  ...
  // predicate CMessageIsValid(msg:CMessage)
  // {
  //   // match msg
  //   //   case CMessage_Invalid => true
  //   //   case CMessage_Request(seqno, value) => CAppRequestIsAbstractable(value)
  //   //   case CMessage_1a(ballot) => CBallotIsValid(ballot)
  //   //   case CMessage_1b(ballot, log_truncation_point, votes) => CBallotIsValid(ballot) && CVotesIsValid(votes)
  //   //   case CMessage_2a(ballot, opn, value) => CBallotIsValid(ballot) && CRequestBatchIsValid(value)
  //   //   case CMessage_2b(ballot, opn, value) => CBallotIsValid(ballot) && CRequestBatchIsValid(value)
  //   //   case CMessage_Heartbeat(bal_heartbeat, suspicious, opn_ckpt) => CBallotIsValid(bal_heartbeat)
  //   //   case CMessage_Reply(seqno, reply) => CAppReplyIsAbstractable(reply)
  //   //   case CMessage_AppStateRequest(bal_state_req, opn_state_req) => CBallotIsValid(bal_state_req)
  //   //   case CMessage_AppStateSupply(bal_state_supply, opn_state_supply, app_state) => CBallotIsValid(bal_state_supply) && CAppStateIsAbstractable(app_state)
  //   //   case CMessage_StartingPhase2(bal_2, logTruncationPoint_2) => CBallotIsValid(bal_2)
  //   && IsInjective(AbstractifyCMessageToRslMessage)
  //   && CMessageIsAbstractable(msg)
  // }
  ...
  //     case CMessage_1b(ballot, log_truncation_point, votes) => CBallotIsAbstractable(ballot) && CVotesIsAbstractable(votes)
  //     case CMessage_2a(ballot, opn, value) => CBallotIsAbstractable(ballot) && CRequestBatchIsAbstractable(value)
  //     case CMessage_2b(ballot, opn, value) => CBallotIsAbstractable(ballot) && CRequestBatchIsAbstractable(value)
  //     case CMessage_Heartbeat(bal_heartbeat, suspicious, opn_ckpt) => CBallotIsAbstractable(bal_heartbeat)
  //     case CMessage_Reply(seqno, reply) => CAppMessageIsAbstractable(reply)
  //     case CMessage_AppStateRequest(bal_state_req, opn_state_req) => CBallotIsAbstractable(bal_state_req)
  //     case CMessage_AppStateSupply(bal_state_supply, opn_state_supply, app_state, reply_cache) => CBallotIsAbstractable(bal_state_supply) && CAppStateIsAbstractable(app_state) && CReplyCacheIsAbstractable(reply_cache)
  //     case CMessage_StartingPhase2(bal_2, logTruncationPoint_2) => CBallotIsAbstractable(bal_2)
  // }
  ...
  //     case CMessage_2a(ballot, opn, value) => RslMessage_2a(AbstractifyCBallotToBallot(ballot), AbstractifyCOperationNumberToOperationNumber(opn), AbstractifySeq(value, AbstractifyCRequestToRequest))
  //     case CMessage_2b(ballot, opn, value) => RslMessage_2b(AbstractifyCBallotToBallot(ballot), AbstractifyCOperationNumberToOperationNumber(opn), AbstractifySeq(value, AbstractifyCRequestToRequest))
  ...
  //   // && IsInjective(AbstractifyCPacketToRslPacket)
  // }
  ...
  //   // ensures forall i, j :: CPacketIsAbstractable(i) && CPacketIsAbstractable(j) && AbstractifyCPacketToRslPacket(i) == AbstractifyCPacketToRslPacket(j) ==> i == j
  // {
