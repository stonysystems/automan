...
datatype CParameters = CParameters(max_seqno:nat, max_delegations:nat)

predicate CParametersIsAbstractable(params:CParameters)
{
    true
}

function AbstractifyCParametersToParameters(params:CParameters) : Parameters
requires CParametersIsAbstractable(params)
{
...
{
    && CParametersIsAbstractable(params)
