  ...
  decreases |creqb|
{
  ...
  // if (|creqb| > 0){
  //   print "cur req size: ", |ces.requests_received_this_epoch|, "\n";
  //   print "prev req size: ", |ces.requests_received_prev_epochs|, "\n";
  // }
  ...
  //   print "Election remove executed takes: ", end_time - start_time, "\n";
  // }
}
