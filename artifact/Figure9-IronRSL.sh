...
CODE_DIR="IronRSL"
Line="IronRSL"
PARAM_FILE="$CODE_DIR/ironfleet/src/Dafny/Distributed/Impl/RSL/ParametersState.i.dfy"
PROPOSER="$CODE_DIR/ironfleet/src/Dafny/Distributed/Impl/RSL/ProposerModel.i.dfy"
