...
*/
    ...
    lemma {:fuel ValInGrammar,3} lemma_ParseMarshallGetRequest(bytes:seq<byte>, msg:SingleMessage) returns (reserved_bytes:seq<byte>)
    ...
    lemma {:fuel ValInGrammar,5} lemma_ParseMarshallSetRequest(bytes:seq<byte>, msg:SingleMessage) returns (reserved_bytes:seq<byte>)
    ...
    lemma {:fuel ValInGrammar,5} lemma_ParseMarshallReply(bytes:seq<byte>, reply:AppReply, msg:SingleMessage, reserved_bytes:seq<byte>) 
        requires CSingleMessageIsAbstractable(SHTDemarshallData(bytes));
        requires AbstractifyCSingleMessageToSingleMessage(SHTDemarshallData(bytes)) == msg;
